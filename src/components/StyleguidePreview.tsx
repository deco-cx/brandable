...
const StyleguidePreview: React.FC<Props> = ({
  ...
  return <div className={`glass-card p-6 transition-all duration-1000 ${backgroundClass}`}>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {colorPalette.map((color, index) => <div key={index} className="text-center">
                  <div className="h-8 w-8 rounded-full mb-1 mx-auto transition-colors duration-700" style={{
      ...
      <div className="mt-5 border-t pt-5">
        ...
        <Textarea placeholder="Describe the landing page you want to generate with this brand style..." className={`${fontFamily} mb-3 bg-white/50 transition-all duration-700`} rows={3} />
        <div className="flex justify-center">
          <Button className={`${buttonClass} font-medium px-6 py-2 rounded-full transition-colors duration-700`}>
